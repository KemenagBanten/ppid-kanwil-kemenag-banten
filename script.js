...
/* Kartu berita tidak lagi berjajar */
.berita-section .news-card {
  width: 100%;
  max-width: none;
}

/* Saat berita kosong, panel berita eksternal
   menggunakan ruang yang tersedia */
.berita-section .berita-external {
  width: 100%;
  min-height: 100%;
}

/* Supaya isi berita tidak terlalu sempit */
.berita-section .news-content {
  width: 100%;
}

/* Gambar berita tetap proporsional */
